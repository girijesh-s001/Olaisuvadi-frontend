...
export const TAMIL_GROUPS: TamilGroup[] = [
  {
    ...
    chars: [
      ...
      { char: "எ", label: "YE_vowel", name: "எ (e)", variants: [{ label: "YE_vowel", description: "Standard form" }] },
      { char: "ஏ", label: "YEE_vowel", name: "ஏ (ē)", variants: [{ label: "YEE_vowel", description: "Standard form" }] },
  ...
  },
  {
    ...
    chars: [
      ...
      { char: "கெ", label: "KE", name: "கெ", variants: [{ label: "KE", description: "Standard form" }] },
      { char: "கே", label: "KEE", name: "கே", variants: [{ label: "KEE", description: "Standard form" }] },
